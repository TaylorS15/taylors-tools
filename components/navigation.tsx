...
export default async function Navigation() {
  ...
  return (
    <div className="fixed left-1/2 z-50 mt-4 flex h-12 -translate-x-1/2 items-center gap-9 rounded-lg px-4 shadow-lg-center backdrop-blur-lg">
      <p className="-mr-2 cursor-pointer bg-gradient-to-br from-blue-700 from-10% via-cyan-500 to-blue-700 to-90% bg-clip-text text-xl font-bold text-transparent drop-shadow-md">
        t-t
      </p>

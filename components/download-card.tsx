    ...
    >
      <div className="flex h-full w-full flex-col gap-4 rounded-[calc(0.5rem-4px)] bg-white p-4">
        ...
        <div className="flex w-full items-center gap-4">
          <Download className="h-12 w-12 font-medium text-blue-600" />
          <p className="text-lg font-medium">Have a download code?</p>
        </div>
        <p className="h-full w-full max-w-96">
          If you previously saved a download code, enter it here to access your
          file with a secure, temporary, link. If your file was temporary, it
          will be inaccessible after 24 hours.
        </p>
        <div className="flex w-full items-center gap-4">
          <input
            type="text"
            ...
            className="w-24 rounded-lg border border-zinc-200 p-2 focus:outline-none active:outline-none"
            placeholder="ABC123"
            maxLength={6}
          />
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-zinc-200 p-2 text-zinc-700 transition hover:bg-zinc-50"
          >
            Enter
          </button>
